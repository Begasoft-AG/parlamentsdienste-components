...
| `characterCountText` | `character-count-text` | Shows a text/hint addition to the character count.                                                                                                                                                                                                                                                                                                   | `string`                                                                                        | `undefined` |
...
| `showCharacterCount` | `show-character-count` | Shows the character count below the input.                                                                                                                                                                                                                                                                                                           | `boolean`                                                                                       | `false`     |
...
| `pd-change` | Emitted when the value has changed.     | `CustomEvent<number \| string>` |
