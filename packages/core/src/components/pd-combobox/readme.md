...
| `emptyItemData`             | --                            | Data used for the empty item                                                                                               | `DropdownItem`                   | `{         id: 'emptyitem',         label: '-',         value: null,     }` |
...
| `items`                     | --                            | Values shown as combobox items                                                                                             | `DropdownItem[]`                 | `[]`                                                                        |
...
| `selected`                  | --                            | To select an item by prop. This prop is used for the two-way binding.                                                      | `DropdownItem \| DropdownItem[]` | `null`                                                                      |
